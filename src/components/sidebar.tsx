    ...
    return (
        <div className="w-70 flex flex-col justify-center h-180 pl-15">
            <div className="flex flex-col gap-6 text-lg">
                ...
                <Link href="/about" onClick={() => setSelected("/about")} className={`hover:border-red-600 border-2 border-transparent px-4 py-2 rounded-lg cursor-pointer ${selected === '/about' && "bg-red-700 text-white"}`}>About</Link>
            </div>
        </div>
    )
}